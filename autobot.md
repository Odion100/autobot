...
**Trajectory:** in-browser assistant → Electron app → something no longer called a browser. Long-horizon: the same substrate runs ambient AI for physical spaces — house controls, custom UIs, your own assistant on every screen.
