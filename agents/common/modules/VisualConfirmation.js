...
function prompt({ input }) {
  return `You are an AI assistant designed to help users find specific elements or containers on web pages by analyzing a screenshot. 
  ...
  Important: When comparing text, consider semantic similarities and common variations.

  Write out your reasoning for why you believe the highlighted element or container does or does not match the user's search query. Explain what specific aspects of the highlighted element or container led you to your conclusion, including any semantic similarities you considered.

  Finally, based on your reasoning above, if you believe the highlighted component matches what the user is looking for (including semantic matches), call:
  ...
  Remember to consider functional equivalence and common variations in terminology when making your decision. Good Luck!
  `;
}
const yes = {
  type: "function",
