export default function prompt({ input, state } = {}) {
  ...
  2. For each step:
     ...
     c. Analyze the screenshot to collect all the text in the same container or surrounding the target element.
     d. Specify the function to call with highly specific arguments that uniquely identify the target element.
     e. Explain your reasoning behind this action, referencing the specific details you used to identify the element.
