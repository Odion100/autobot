...
`;
export const SEARCH_HELP_MESSAGE = `@internalInstructions:Please revise your search terms for selecting the container and element you want to interact with by following these steps:
